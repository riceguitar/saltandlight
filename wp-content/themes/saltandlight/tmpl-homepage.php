...
<section class="home-box">
	...
	<div class="container">
		<div class="john-video-bg">
			...
			<?php the_field('background_video_code'); ?>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="john-quote text-center">
						<img src="<?php echo get_template_directory_uri() . '/img/john-circle.png'; ?>" class="john-float" style="display: none;" />
					...
					<div class="row home-ctas">
						<div class="col-sm-6 text-right">
							<a href="<?php the_field('button_left_link'); ?>" class="max-button max-red text-center"><?php the_field('button_left'); ?></a>
						</div>
						<div class="col-sm-6 text-left">
							<a href="<?php the_field('button_right_link'); ?>" class="max-button max-red text-center"><?php the_field('button_right'); ?></a>
						</div>
					</div>
